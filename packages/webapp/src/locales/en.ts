export default {
  ...
  login: {
    ...
    bindAccountDescription: 'Already a MySurveyPro user? Login and link your account.',
  ...
  project: {
    ...
    templatesProject: {
      tagLine: 'choose the build in template and use to get ideal experience'
    },
    rename: 'Rename',
    del: 'Delete',
  ...
  user: {
    ...
    settings: {
      avatar: 'Avatar',
      avatarText:
        'Gravatar is used by default as your MySurveyPro avatar, you can upload your custom avatar here',
      deletedAccount: {
        sendEmail: 'An email containing a verification code was sent to',
        del: 'Delete account',
        delText:
      ...
      subscription: {
        ...
        subText: 'This will cancel subscription of your account.',
        sub: 'Cancel Subscription',
        subButton: 'Cancel Subscription',
        subdescription: 'Cancel Immediately: You will lose access to all features immediately upon confirmation.'
      },
      emailAddress: {
  ...
  share: {
    ...
    embedWeb: [
      {
        title: 'Standard',
        description: 'Present MySurveyPro as part of your website'
      },
      {
        title: 'Popup',
        description: 'MySurveyPro pops up in the center of the screen.'
      },
      {
        title: 'Popup over',
  ...
  formSettings: {
    ...
    archiveText:
      "Disable the submission archive if you don't want MySurveyPro to store your submissions.",
  ...
  integration: {
    ...
    tableText3:
      "Map MySurveyPro to Airtable fields. It's crucial to type the Airtable field names exactly as they appear in your table. If you change a field name on Airtable, please update it here too, otherwise the integration won't work as expected.",
    DropboxText:
    ...
    MapFields: 'Map fields',
    googleSheet:
      "Map MySurveyPro to Google Sheets fields. If you change a field on Google Sheets, please update it here too, otherwise the integration won't work as expected.",
    leftPlaceholder: 'MySurveyPro question',
    rightPlaceholder: 'Google Sheets field',
    leftTipText: 'Select MySurveyPro question',
    rightTipText: 'Select Google Sheets field',
    ColumnValues: 'Column values (optional)',
    mondayText:
      "Map MySurveyPro to Monday columns. If you change a column on Monday, please update it here too, otherwise the integration won't work as expected.",
    Board: 'Board',
    ...
    AuthorizationText: 'First off all, please authorize MySurveyPro to access your data',
    login: 'Login to',

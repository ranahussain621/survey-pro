          ...
          <div className="mb-10">
            <div className="mb-4">
              ...
              <div className="mt-1 text-[13px] text-[#8a94a6]">
                Retrieve data about all the workspaces in your MySurveyPro account
              </div>
            </div>
            ...
            <div className="mb-4">
              ...
              <div className="mt-1 text-[13px] text-[#8a94a6]">
                Retrieve data about all the project in your MySurveyPro workspace
              </div>
            </div>
            ...
            <div className="mb-4">
              ...
              <div className="mt-1 text-[13px] text-[#8a94a6]">
                Retrieve data about all the forms in your MySurveyPro project
              </div>
            </div>
            ...
            <div className="mb-4">
              ...
              <div className="mt-1 text-[13px] text-[#8a94a6]">
                Retrieve your MyFurveyPro account information
              </div>
            </div>
          </div>

      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:pt-24">
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              ...
              <div className="mt-12 md:mt-0">
                ...
                <ul className="mt-4 space-y-2">
                  ...
                  <li>
                    <a
                      href="https://discord.gg/sgT4v4GSTe"
                      className="text-base text-slate-800 hover:underline"
                    >
                      Community
                    </a>
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                ...
                <ul className="mt-4 space-y-2">
                  ...
                  <li>
                    <a
                      href="https://heyform.net/help/faqs"
                      className="text-base text-slate-800 hover:underline"
                    >
                      FAQ
                    </a>
                  ...
                  <li>
                    <a
                      href="https://climate.stripe.com/Vxe5z7"
                      className="text-base text-slate-800 hover:underline"
                    >
                      Climate Pledge
                    </a>
              ...
              <div className="mt-12 md:mt-0">
                ...
                <ul className="mt-4 space-y-2">
                  ...
                  <li>
                    <a
                      href="https://heyform.net/f/E4MKK2hx"
                      className="text-base text-slate-800 hover:underline"
                    >
                      Abuse
                    </a>
        ...
        <div className="mt-12 pt-8">
          <p className="text-base text-slate-800 xl:text-center">
            ©2024 MySurveyPro, a side project built in public by{' '}
            <a href="https://isureglobalsolutions.com/" className="font-medium text-slate-950 underline hover:underline">
